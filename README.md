...
Cloud Agent を使った自動レビュー・自立型エージェント組織の設定は [docs/cursor-automations/](docs/cursor-automations/) を参照。エージェント向け手順は [AGENTS.md](AGENTS.md)、VM 環境は [.cursor/environment.json](.cursor/environment.json) に定義しています。
